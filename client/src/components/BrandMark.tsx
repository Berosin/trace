 ...
 * matching the template's "Cpu + SYS.INT" navbar pattern. No illustration —
 * brutalist branding is typographic.
 */
  ...
  if (compact) {
    return (
      <div className={`flex items-center gap-2 ${className ?? ""}`}>
        ...
        <span className="text-xs font-mono font-bold tracking-[0.15em] uppercase text-ink">TRACE.SYS</span>
      </div>
    );
  }
  ...
  return (
    <div className={className}>
      <div className="flex items-center gap-3 border-2 border-ink px-4 py-3 bg-panel w-fit">
        ...
        <span className="text-lg font-mono font-bold tracking-[0.15em] uppercase text-ink">TRACE.SYS</span>
